...
public class Division {
	...
	@Test
	void Divison() throws InterruptedException, IOException {
		...
		FileUtils.copyFile(src, new File(Config.current_work_directory + File.separator + "/ScreenShots/Divison.png"));
