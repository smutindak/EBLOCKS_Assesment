...
public class Subtraction {
	@Test
	void Subtraction() throws InterruptedException, IOException {
		...
		FileUtils.copyFile(src, new File(CurrentWorkingDirectory.current + File.separator + "/ScreenShots/Subtraction.png"));
